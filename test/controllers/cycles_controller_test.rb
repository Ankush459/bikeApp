...
class CyclesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cycle" do
    assert_difference('Cycle.count') do
      post cycles_url, params: { cycle: { color: @cycle.color, cost: @cycle.cost, destination: @cycle.destination, firstname: @cycle.firstname, lastname: @cycle.lastname } }
    end
  ...
  test "should update cycle" do
    patch cycle_url(@cycle), params: { cycle: { color: @cycle.color, cost: @cycle.cost, destination: @cycle.destination, firstname: @cycle.firstname, lastname: @cycle.lastname } }
